...
const ja: Translation = {
  ...
  questions: {
    ...
    q4_fire: {
      text: '建物内に火災、煙、浸水などの明らかな危険がありますか？',
      shortLabel: '火災・煙・浸水',
...
const en: Translation = {
  ...
  questions: {
    q1_tilt: {
      text: 'Is the building clearly tilting?',
    ...
    q2_crack: {
      text: 'Are there major cracks or damage to the columns or beams?',
    ...
    q3_ceiling: {
      text: 'Is there a major risk of the ceiling or walls collapsing or falling?',
    ...
    q4_fire: {
      text: 'Is there obvious danger inside the building, such as fire, smoke, or flooding?',
    ...
    q5_gas: {
      text: 'Is there a smell of gas in or around the building?',
      shortLabel: 'Gas odor',
      dangerDescription:
